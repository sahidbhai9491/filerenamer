...
function BatchRenameFileMacHero() {
    return (
        <Container>
            <section className="flex flex-col items-center text-sm bg-[url('https://raw.githubusercontent.com/prebuiltui/prebuiltui/main/assets/hero/bg-with-grid.png')] bg-cover bg-center bg-no-repeat">
                <div className="flex flex-col items-center max-md:px-2 w-full">
                    ...
                    <h1 className="text-center text-3xl leading-[50px] md:text-5xl md:leading-20 font-semibold max-w-4xl text-slate-900 mt-4">
                        Batch Rename Files on Mac Easily
                    </h1>

                    <p className="text-base text-gray-600 max-w-4xl mx-auto text-center py-2">On macOS, renaming one file is simple. The problem starts when you need to rename many files together. Finder offers basic options, but once naming rules become complex, things quickly feel limited and confusing.</p>
...
export default BatchRenameFileMacHero;