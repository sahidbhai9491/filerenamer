...
function WindowFileRenamerHero() {
    return (
        <Container>
            <section className="flex flex-col items-center text-sm bg-[url('https://raw.githubusercontent.com/prebuiltui/prebuiltui/main/assets/hero/bg-with-grid.png')] bg-cover bg-center bg-no-repeat">
                <div className="flex flex-col items-center max-md:px-2 w-full">
                    ...
                    <h1 className="text-center text-3xl leading-[50px] md:text-5xl md:leading-20 font-semibold max-w-4xl text-slate-900 mt-4">
                        Windows File Renamer for Bulk File Renaming
                    </h1>

                    <p className="text-base text-gray-600 max-w-4xl mx-auto text-center py-2">RenameTool works directly in your browser on Windows, allowing you to rename, preview, and organize files locally with full privacy and complete control over your folders.</p>
...
export default WindowFileRenamerHero;